...
const Header = () => {
  ...
  const handleLinkClick = (e, linkName, hash) => {
    e.preventDefault();
        ...
        <ul className="flex flex-wrap w-[22rem] items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5">
          {LINKS.map((link) => (
            ...
            >
              <a
                className={clsx(
                  "flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-400 dark:hover:text-gray-200 cursor-pointer",
                  {
