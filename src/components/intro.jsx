    ...
    >
      ...
      >
        <div className="flex gap-2 flex-col sm:flex-row text-lg font-medium">
          <a
            href="#contact"
            className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-105 hover:scale-105 hover:bg-gray-950 active:scale-95 transition cursor-pointer"
